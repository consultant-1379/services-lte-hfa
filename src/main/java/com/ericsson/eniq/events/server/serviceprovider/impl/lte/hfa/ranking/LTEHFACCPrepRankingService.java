...
import static com.ericsson.eniq.events.server.common.ApplicationConfigConstants.DEFAULT_EVENT_FAILURE_RANKING_COUNT;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CATEGORY_ID_SQL_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.LTE_HFA_CAUSE_CODE_RANKING_PREP_ANALYSIS;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.LTE_HFA_PREP_CATEGORY_ID;

import static com.ericsson.eniq.events.server.common.ApplicationConstants.TZ_OFFSET;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_LTE_HFA;
import static com.ericsson.eniq.events.server.common.tablesandviews.TableKeys.HIER3_CC;
...
@Stateless
@Local(Service.class)
public class LTEHFACCPrepRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_CAUSE_CODE_RANKING_PREP_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(CATEGORY_ID_SQL_PARAM, requestParameters.getFirst(CATEGORY_ID_PARAM));
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (categoryID != null) {
            ...
            dataServiceParameters.put(CATEGORY_ID_SQL_PARAM,
                    QueryParameter.createStringParameter(LTE_HFA_PREP_CATEGORY_ID));
        }
        return dataServiceParameters;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER3_CC, EventDataSourceType.AGGREGATED_15MIN,
