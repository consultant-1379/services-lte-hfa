...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureTgtECellDetailedEAService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(EVENT_ID, requestParameters.getFirst(EVENT_ID_SQL_PARAM));
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_TARGET_ECELL_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParameters.add(EVENT_ID_SQL_PARAM);
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        dataServiceParameters.put(EVENT_ID_SQL_PARAM,
                QueryParameter.createStringParameter(requestParameters.getFirst(EVENT_ID_SQL_PARAM)));
        final String hashedIdForCell = requestParameters.getFirst(THIER321_HASHID);
        if (hashedIdForCell != null) {
            dataServiceParameters.put(THIER321_HASHID, QueryParameter.createStringParameter(hashedIdForCell));
        }
        return dataServiceParameters;
    }
