...
@Stateless
@Local(Service.class)
public class LTEHFAEnodeBQCIEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_QOS_QCI_ENODEB_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if(node!=null)
        {
        	 dataServiceParameters.put(NODE,
                     QueryParameter.createStringParameter(node));
        }
        if (requestParameters.getFirst(CONTROLLER_SQL_ID) != null) {
            dataServiceParameters.put(CONTROLLER_SQL_ID,
                    QueryParameter.createLongParameter(Long.parseLong(requestParameters.getFirst(CONTROLLER_SQL_ID))));
        }
        dataServiceParameters.put(QCI_ID_SQL_ID,
                QueryParameter.createIntParameter(Integer.parseInt(requestParameters.getFirst(QCI_ID_SQL_ID))));
        dataServiceParameters.put(CATEGORY_ID_2,
                QueryParameter.createIntParameter(Integer.parseInt(requestParameters.getFirst(CATEGORY_ID_2))));
        if(requestParameters.getFirst(HIERARCHY_3_SQL)!=null){
        dataServiceParameters.put(HIERARCHY_3_SQL,
                QueryParameter.createStringParameter(String.valueOf(requestParameters.getFirst(HIERARCHY_3_SQL))));
        }
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParams.add(QCI_ID_SQL_ID);
        requiredParams.add(CATEGORY_ID_2);
