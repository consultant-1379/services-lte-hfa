...
@Stateless
@Local(Service.class)
public class TerminalDetailedEAService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (requestParameters.getFirst(TAC_PARAM) != null) {
          serviceSpecificTemplateParameters.put(TAC, requestParameters.getFirst(TAC_PARAM));
        }
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_TERMINAL_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.getFirst(TAC) != null) {
            dataServiceParameters.put(TAC,
                    QueryParameter.createIntParameter(Integer.valueOf(requestParameters.getFirst(TAC))));
        }
        return dataServiceParameters;
    }
