...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureTgtECellHandoverStageService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_TARGET_ECELL_HANDOVER_STAGE_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        long hashedIdForCell = 0; //THIER321_ID
