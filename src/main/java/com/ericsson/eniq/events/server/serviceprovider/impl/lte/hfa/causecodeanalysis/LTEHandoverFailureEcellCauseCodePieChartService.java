...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureEcellCauseCodePieChartService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(final MultivaluedMap<String, String> requestParameters,
        ...
        if (node != null) {
            ...
            hashedIdForController = getQueryUtils().createHashIDForCell(allData[4], allData[2], allData[1], allData[0], allData[3]);
            serviceSpecificTemplateParameters.put(NODE, QueryParameter.createStringParameter(requestParameters.getFirst(NODE_PARAM)));
            if (hashedIdForController != 0) {
                serviceSpecificTemplateParameters.put(CELL_SQL_ID, hashedIdForController);
            }
        }
    ...
    public String getTemplatePath() {
        return LTE_HFA_ECELL_CAUSE_CODE_ANALYSIS_BY_PIE_CHART;
    }
     ...
     * 
     * @see
     * com.ericsson.eniq.events.server.serviceprovider.impl.GenericService#getServiceSpecificDataServiceParameters(javax.ws.rs.core.MultivaluedMap)
     */
    @Override
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(final MultivaluedMap<String, String> requestParameters) {
        ...
        if (hashedIdForController != 0) {
            queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(hashedIdForController));
        }
