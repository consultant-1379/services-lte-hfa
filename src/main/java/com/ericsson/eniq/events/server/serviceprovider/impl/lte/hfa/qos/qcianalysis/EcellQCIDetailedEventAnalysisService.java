...
@Stateless
@Local(Service.class)
public class EcellQCIDetailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_QOS_QCI_ECELL_DETAILED_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String hashedIdForController = requestParameters.getFirst(CELL_SQL_ID);
        if (hashedIdForController != null) {
            dataServiceParameters.put(CELL_SQL_ID,
                    QueryParameter.createLongParameter(Long.parseLong(hashedIdForController)));
        }
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParams.add(EVENT_ID_PARAM);
