...
@Stateless
@Local(Service.class)
public class LTEHFAEnodeBCCEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_ENODEB_CAUSE_CODE_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForControllerAsString == null) {
            ...
            if (node != null) {
                final String[] allData = node.split(DELIMITER);
                hashedIdForController = getQueryUtils().createHashIDForController(allData[2], allData[0], allData[1]);
                dataServiceParameters.put(NODE, QueryParameter.createStringParameter(node));
            }
        } else {
            hashedIdForController = Long.parseLong(hashedIdForControllerAsString);
        }
