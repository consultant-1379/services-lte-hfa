...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureEcellCauseCodeListService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_ECELL_CAUSE_CODE_LIST;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (node != null) {
            ...
            hashedIdForController = getQueryUtils().createHashIDForCell(allData[4], allData[2], allData[1], allData[0],
                    allData[3]);
