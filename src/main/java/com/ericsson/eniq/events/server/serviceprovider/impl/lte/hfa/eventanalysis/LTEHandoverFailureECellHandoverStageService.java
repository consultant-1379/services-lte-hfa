...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureECellHandoverStageService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_ECELL_HANDOVER_STAGE_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        long hashedIdForCell = 0; //HIER321_ID
