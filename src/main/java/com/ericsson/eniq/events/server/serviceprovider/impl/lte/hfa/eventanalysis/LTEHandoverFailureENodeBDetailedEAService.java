...
@Stateless
@Local(Service.class)
public class LTEHandoverFailureENodeBDetailedEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_ENODEB_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String hashedIdForController = requestParameters.getFirst(HIER3_ID);
        if (hashedIdForController != null) {
            dataServiceParameters.put(HIER3_ID, QueryParameter.createStringParameter(hashedIdForController));
        }
        return dataServiceParameters;
    }
