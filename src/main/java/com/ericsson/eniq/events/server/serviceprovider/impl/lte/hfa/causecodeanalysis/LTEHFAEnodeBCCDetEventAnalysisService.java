...
@Stateless
@Local(Service.class)
public class LTEHFAEnodeBCCDetEventAnalysisService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (hashedIdForController != 0) {
            serviceSpecificTemplateParameters.put(CONTROLLER_SQL_ID, hashedIdForController);
        }
    ...
    public String getTemplatePath() {
        return LTE_HANDOVER_FAILURE_ENODEB_CAUSE_CODE_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForController != 0) {
            dataServiceParameters.put(HIER3_ID, QueryParameter.createLongParameter(hashedIdForController));
        }
        return dataServiceParameters;
    }
