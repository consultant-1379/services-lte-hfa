...
@Stateless
@Local(Service.class)
public class LTEHFATerminalPrepRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_TAC_RANKING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (categoryID != null) {
            serviceSpecificTemplateParameters.put(CATEGORY_ID_SQL_PARAM,
                    QueryParameter.createStringParameter(requestParameters.getFirst(CATEGORY_ID_PARAM)));
        } else {
            serviceSpecificTemplateParameters.put(CATEGORY_ID_SQL_PARAM, LTE_HFA_PREP_CATEGORY_ID);
        }
