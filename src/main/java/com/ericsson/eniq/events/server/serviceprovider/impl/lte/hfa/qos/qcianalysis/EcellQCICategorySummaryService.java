...
@Stateless
@Local(Service.class)
public class EcellQCICategorySummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_HFA_QOS_QCI_ECELL_CATEGORY_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(AGGREGATION_VEIW_LIST, techPackList.getTechPack(EVENT_E_LTE_HFA)
        ...
        if (hashedIdForCellAsString == null) {
            ...
            if (node != null) {
                ...
                hashedIdForCell = getQueryUtils().createHashIDForCell(allData[4], allData[2], allData[1], allData[0],
                        allData[3]);
                hierarchy1 = allData[0];
            }
        } else {
            hashedIdForCell = Long.parseLong(hashedIdForCellAsString);
        }
        if (hashedIdForCell != 0) {
            queryParameters.put(CELL_SQL_NAME, QueryParameter.createStringParameter(hierarchy1));
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER321_EVENTID_QCI, EventDataSourceType.AGGREGATED_15MIN,
