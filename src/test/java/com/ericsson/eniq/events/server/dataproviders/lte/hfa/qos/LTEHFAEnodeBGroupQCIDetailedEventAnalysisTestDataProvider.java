 ...
 *
 */
public class LTEHFAEnodeBGroupQCIDetailedEventAnalysisTestDataProvider {

    private LTEHFAEnodeBGroupQCIDetailedEventAnalysisTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
               ...
               .add(EVENT_ID_PARAM, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, INTERNAL_PROC_HO_EXEC_X2_IN_HFA,
                		...
                		.add(GROUP_NAME_PARAM, SAMPLE_BSC_GROUP)
                .build();
