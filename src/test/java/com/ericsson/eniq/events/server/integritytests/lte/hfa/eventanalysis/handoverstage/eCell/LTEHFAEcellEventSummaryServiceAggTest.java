...
public class LTEHFAEcellEventSummaryServiceAggTest extends BaseDataIntegrityTest<LTEHFAEcellEventSummaryResultRaw> {
    ...
    private void insertAggDataDay() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID,
    ...
    private void insertAggData15Min() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID,
    ...
    @Test
    public void testEcellEventSummaryDayPrep() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEcellEventSummaryDayExec() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEcellEventSummary15minPrep() throws Exception {
        insertAggData15Min();
    ...
    @Test
    public void testEcellEventSummary15minExec() throws Exception {
        insertAggData15Min();
    ...
    private void assertResultDay(final List<LTEHFAEcellEventSummaryResultRaw> results) {
