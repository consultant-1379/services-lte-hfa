 ...
 *
 */
public class LTEHFAENodeBQCIEventSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAQOSENodeBQCIEventSummaryResult> {
    ...
    @Test
    public void testENodeBQCICategaryEventSummaryPrep() throws Exception {
        ...
        final List<LTEHFAQOSENodeBQCIEventSummaryResult> qciResult = rt.translateResult(json,
                LTEHFAQOSENodeBQCIEventSummaryResult.class);
        assertThat(qciResult.size(), is(2));
        for (final LTEHFAQOSENodeBQCIEventSummaryResult rs : qciResult) {
    ...
    @Test
    public void testENodeBQCICategaryEventSummaryExec() throws Exception {
