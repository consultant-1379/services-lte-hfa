...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.hfa.eventanalysis.*;
...
public class LTEHFATgtECellDetailedAnalysisServiceRawTest extends BaseDataIntegrityTest<LTEHFAECELLDetailedAnalysisSetupResult> {
    ...
    public void onSetUp() throws Exception {
        lteHandoverFailureTgtECellDetailedEAService = new LTEHandoverFailureTgtECellDetailedEAService();
        attachDependencies(lteHandoverFailureTgtECellDetailedEAService);
    ...
    private void createTable() throws Exception {
        ...
        Map<String, Nullable> columnsForTableRaw = new HashMap<String, Nullable>();
    ...
    private String getJsonResult(final String eventId, final String dateFrom, final String dateTo) {
        ...
        requestParameters.putSingle(THIER321_HASHID, TEST_VALUE_HIER321_ID_1);
        requestParameters.putSingle(MAX_ROWS, DEFAULT_MAX_ROWS);

        return runQuery(lteHandoverFailureTgtECellDetailedEAService, requestParameters);
    }
    ...
    public void testEcellAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        final List<LTEHFAECELLDetailedAnalysisSetupResult> eventResult = rt.translateResult(json, LTEHFAECELLDetailedAnalysisSetupResult.class);
