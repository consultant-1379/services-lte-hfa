...
public class EcellGroupQCIEventSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAQOSEcellGroupQCIEventSummaryResult> {
    ...
    private void insertData(final String tac, final long hier321ID, final int categoryID, final String eventID,
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEcellGroupQCIEventSummaryPrep() throws Exception {
        ...
        final List<LTEHFAQOSEcellGroupQCIEventSummaryResult> eventResult = rt.translateResult(json,
        		LTEHFAQOSEcellGroupQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(1));
    }

    @Test
    public void testEcellGroupQCIEventSummaryExec() throws Exception {
