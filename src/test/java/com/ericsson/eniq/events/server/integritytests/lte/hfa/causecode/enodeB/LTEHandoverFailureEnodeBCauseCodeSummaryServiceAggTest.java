...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw;
import com.sun.jersey.core.util.MultivaluedMapImpl;


public class LTEHandoverFailureEnodeBCauseCodeSummaryServiceAggTest extends BaseDataIntegrityTest<LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw> {
    ...
    private void insertData() throws Exception {
        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_IN_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_OUT_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_IN_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_S1_IN_HFA,DATETIME_ID_DAY_1,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
        ...
        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_IN_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_OUT_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_IN_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_S1_IN_HFA,DATETIME_ID_15MIN_1,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_S1_OUT_HFA,DATETIME_ID_15MIN_1,1);

        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_IN_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_PREP,
                INTERNAL_PROC_HO_PREP_S1_OUT_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_1,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_IN_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_2,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_3,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_S1_IN_HFA,DATETIME_ID_15MIN_2,1);
        insertRawData(TEST_VALUE_IMSI_4,TEST_VALUE_HIER3_ID,SAMPLE_TAC,EventIDConstants.CATEGORY_ID_2_EXEC,
                INTERNAL_PROC_HO_EXEC_S1_OUT_HFA,DATETIME_ID_15MIN_2,1);
    ...
    private void insertAggData15Min() throws Exception {
        ...
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        ...
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
    ...
    @Test
    public void testEnodeBCauseCodeSummaryDay() throws Exception {
        insertAggDataDay();
        final String json = getJsonResultDay();
        final ResultTranslator<LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw.class);
        assertResult(eventResult);
    }

    @Test
    public void testEnodeBCauseCodeSummary15min() throws Exception {
        insertAggData15Min();
    ...
    private void assertResult(final List<LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw> results) {
        assertThat(results.size(), is(8));
        for (final LTEHandoverFailureEnodeBCauseCodeSummaryResultRaw rs : results) {
            assertEquals(rs.getNoOfErrors(), "30");
