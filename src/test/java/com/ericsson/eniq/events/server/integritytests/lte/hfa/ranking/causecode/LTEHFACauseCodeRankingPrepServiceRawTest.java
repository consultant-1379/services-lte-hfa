 ...
 *
 */
public class LTEHFACauseCodeRankingPrepServiceRawTest extends
    ...
    private void insertData() throws SQLException {
        ...
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_2, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, dateTime, 3);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_3, INTERNAL_PROC_HO_PREP_S1_IN_HFA, dateTime, 2);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_4, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, dateTime, 1);
    }
    ...
    public void testGetLTEHFACauseCodeCallDropRankingData() throws Exception {
        ...
        final String json = runQuery(LTEHandoverFailureCCPrepRankingService, requestParameters);
