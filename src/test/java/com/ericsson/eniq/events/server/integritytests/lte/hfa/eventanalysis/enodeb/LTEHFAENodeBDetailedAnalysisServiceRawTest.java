...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.hfa.eventanalysis.LTEHandoverFailureENodeBDetailedEAService;
import com.ericsson.eniq.events.server.test.queryresults.ResultTranslator;
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHFAEnodeBDetailedAnalysisSetupResult;
import com.sun.jersey.core.util.MultivaluedMapImpl;
import com.ericsson.eniq.events.server.test.schema.Nullable;

public class LTEHFAENodeBDetailedAnalysisServiceRawTest extends BaseDataIntegrityTest<LTEHFAEnodeBDetailedAnalysisSetupResult> {
    ...
    lteHandoverFailureENodeBDetailedEventAnalysisService = new LTEHandoverFailureENodeBDetailedEAService();
    attachDependencies(lteHandoverFailureENodeBDetailedEventAnalysisService);
    ...
    return runQuery(lteHandoverFailureENodeBDetailedEventAnalysisService, requestParameters);
    }
    ...
    final ResultTranslator<LTEHFAEnodeBDetailedAnalysisSetupResult> rt = getTranslator();
    final List<LTEHFAEnodeBDetailedAnalysisSetupResult> eventResult = rt.translateResult(json, LTEHFAEnodeBDetailedAnalysisSetupResult.class);
    ...
    private void assertResult(final List<LTEHFAEnodeBDetailedAnalysisSetupResult> results, final String eventId) {
    assertThat(results.size(), is(4));
    for (final LTEHFAEnodeBDetailedAnalysisSetupResult rs : results) {
