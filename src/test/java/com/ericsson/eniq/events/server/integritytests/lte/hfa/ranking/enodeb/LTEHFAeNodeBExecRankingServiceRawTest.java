...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.hfa.ranking.LTEHandoverFailureEnodeBExecRankingService;
...
import static com.ericsson.eniq.events.server.test.temptables.TempTableNames.TEMP_DIM_E_SGEH_RAT;
 ...
 *
 */
public class LTEHFAeNodeBExecRankingServiceRawTest extends
    ...
    public void onSetUp() throws Exception {
        lteHandoverFailureEnodeBExecRankingService = new LTEHandoverFailureEnodeBExecRankingService();
        attachDependencies(lteHandoverFailureEnodeBExecRankingService);
    ...
    private void insertData() throws SQLException {
        ...
        insertEnodeBWithDateTime(DateTimeUtilities.getDateTimeMinus2Minutes());
    }
    ...
    @Test
    public void testGetLTEHFAeNodeBExecRankingData() throws Exception {
        ...
        final String json = runQuery(lteHandoverFailureEnodeBExecRankingService, requestParameters);
