...
public class LTEHFAEcellEventVolumeAggTest extends BaseDataIntegrityTest<LTEHFAEventVolumeResult> {
    ...
    private void insertEvent(final String tableName, final String dt, final String eventID, final int instances) throws SQLException {
        ...
        final String localDateId = dt.substring(0, 10);
        valuesForTable.put(DATETIME_ID, dt);
        valuesForTable.put(EVENT_ID, eventID);
