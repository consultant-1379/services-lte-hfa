...
public class ECellGroupQCICategorySummaryServiceAggTest extends BaseDataIntegrityTest<LTEHFAQOSECellGroupQCICategorySummaryResult> {
    ...
    private void insertData(final long hier3ID, final int tac, final int categoryID, final int qciID, final String time, final int instances,
    ...
    private void insertAggData(final String aggTable, final long hire3ID, final int categoryID, final int qciID, final String time,
    ...
    private void insertDataForAggTest(final long hier3ID, final int categoryID, final int qciID, final int instances, final String dateTimeID,
        ...
        insertData(hier3ID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, qciID, dateTimeID, instances, TEST_VALUE_IMSI_1);
        insertData(hier3ID, SAMPLE_TAC, categoryID, qciID, dateTimeID, instances, TEST_VALUE_IMSI_2);
        insertData(hier3ID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, qciID, dateTimeID, instances, TEST_VALUE_IMSI_2);
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);
    }
    ...
    @Test
    public void testECellGroupQCICategorySummary15MinAgg() throws Exception {
    ...
    @Test
    public void testECellGroupQCICategorySummaryDayAgg() throws Exception {
