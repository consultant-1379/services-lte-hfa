...
public class LTEHFATerminalEventSummaryServiceRawTest extends BaseDataIntegrityTest<LTEHFATerminalEventSummaryResultRaw> {
    ...
    private void insertData(final String tac, final String eventID, final String categoryId, final String time, final int instances)
            throws SQLException {
    ...
    private String getJsonResult(final String categoryId, final String tac) throws URISyntaxException {
    ...
    public void testTerminalEventSummaryPrep() throws Exception {
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_PREP, TEST_VALUE_TAC);
    ...
    public void testTerminalEventSummaryExec() throws Exception {
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_EXEC, TEST_VALUE_TAC);
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryPrepForExclusiveTAC() throws Exception {
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_PREP, TEST_VALUE_EXCLUSIVE_TAC);
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryExecForExclusiveTAC() throws Exception {
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_EXEC, TEST_VALUE_EXCLUSIVE_TAC);
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryExecToVerifyUnknownManufacturerAndUnknownModelvalue() throws Exception {
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_EXEC_X2_IN_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_EXEC_S1_IN_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_EXEC, String.valueOf(SAMPLE_TAC_2));
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryPrepToVerifyUnknownManufacturerAndUnknownModelvalue() throws Exception {
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_PREP_X2_IN_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_PREP_X2_OUT_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_PREP_S1_IN_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(SAMPLE_TAC_2), INTERNAL_PROC_HO_PREP_S1_OUT_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_PREP, String.valueOf(SAMPLE_TAC_2));
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryExecToVerifyInvalidManufacturerAndInvalidModelvalue() throws Exception {
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_EXEC_X2_IN_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_EXEC_S1_IN_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, CATEGORY_ID_2_EXEC, DATETIME_ID_RAW, 1);
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_EXEC, String.valueOf(TAC_EQUAL_TO_ZERO));
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
    ...
    @Test
    public void testTerminalEventSummaryPrepToVerifyInvalidManufacturerAndInvalidModelvalue() throws Exception {
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_PREP_X2_IN_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_PREP_X2_OUT_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_PREP_S1_IN_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        insertData(String.valueOf(TAC_EQUAL_TO_ZERO), INTERNAL_PROC_HO_PREP_S1_OUT_HFA, CATEGORY_ID_2_PREP, DATETIME_ID_RAW, 1);
        final String json = getJsonResult(EventIDConstants.CATEGORY_ID_2_PREP, String.valueOf(TAC_EQUAL_TO_ZERO));
        final ResultTranslator<LTEHFATerminalEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHFATerminalEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATerminalEventSummaryResultRaw.class);
        assertResult(eventResult);
    }
