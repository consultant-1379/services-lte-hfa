...
public class LTEHFAEcellGroupCCPieDrilldownTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                ...
                .add(MAX_ROWS, DEFAULT_MAX_ROWS).add(CAUSE_CODE_PARAM, "1").add(GROUP_NAME_PARAM, "temp")
                .add(EVENT_ID_PARAM, "4102", "4111", "4110", "4113").add(TYPE_PARAM, TYPE_CELL).build();
