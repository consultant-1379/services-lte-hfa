...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureECellGroupCCSummaryResultRaw;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHandoverFailureECellGroupCCSummaryServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureECellGroupCCSummaryResultRaw> {
    ...
    private static final String DATE_FROM_FOR_WEEK = "17092011";

    private static final String DATE_TO_FOR_WEEK = "24092011";
    ...
    private void insertData(final long hier3Id, final String eventID, final String causeCD, final int tac, final String time, final int instances)
            throws SQLException {
    ...
    private String getJsonResult(String dateFrom, String dateTo) throws URISyntaxException {
    ...
    private void insertRawData() throws Exception {
        ...
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

    }

    @Test
    public void testECellGroupCCSummary() throws Exception {
        final String json = getJsonResult(DATE_FROM_RAW, DATE_TO_RAW);
        final ResultTranslator<LTEHandoverFailureECellGroupCCSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureECellGroupCCSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureECellGroupCCSummaryResultRaw.class);
        assertResult(eventResult);
    }

    @Test
    public void testECellGroupCCSummaryForWeek() throws Exception {
        final String json = getJsonResult(DATE_FROM_FOR_WEEK, DATE_TO_FOR_WEEK);
        final ResultTranslator<LTEHandoverFailureECellGroupCCSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureECellGroupCCSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureECellGroupCCSummaryResultRaw.class);
        assertResult(eventResult);
    ...
    private void assertResult(final List<LTEHandoverFailureECellGroupCCSummaryResultRaw> results) {
        assertThat(results.size(), is(8));
        for (final LTEHandoverFailureECellGroupCCSummaryResultRaw rs : results) {
            assertEquals(rs.getNoOfErrors(), "7");
        }
    }
}