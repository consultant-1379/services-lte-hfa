...
public class LTEHFAEnodeBGroupEventHandoverStageServiceAggTest extends BaseDataIntegrityTest<LTEHFAEnodeBGroupEventHandoverStageResultRaw> {
    ...
    @Test
    public void testEnodeBGroupEventSummaryDay() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEnodeBGroupEventSummary15min() throws Exception {
        insertAggData15Min();
    ...
    private void assertResultDay(final List<LTEHFAEnodeBGroupEventHandoverStageResultRaw> results) {
