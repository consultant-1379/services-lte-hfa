...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureEnodeBGroupCCListResult;
 ...
 *
 */
public class LTEHandoverFailureEnodeBGroupCCListServiceAggTest extends
        BaseDataIntegrityTest<LTEHandoverFailureEnodeBGroupCCListResult> {
    ...
    private void insertAggDataDay() throws Exception {
        ...
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_DAY, TEST_VALUE_HIER3_ID_1,
        ...
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_DAY, TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_PREP_X2_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_DAY, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
    ...
    private void insertAggData15Min() throws Exception {
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID_1,
        ...
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertHierCCData(TEMP_EVENT_E_LTE_HFA_HIER3_CC_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
    ...
    public void testEnodeBGroupCauseCodeSummaryDay() throws Exception {
        ...
        final ResultTranslator<LTEHandoverFailureEnodeBGroupCCListResult> rt = getTranslator();
        final List<LTEHandoverFailureEnodeBGroupCCListResult> eventResult = rt.translateResult(json,
                LTEHandoverFailureEnodeBGroupCCListResult.class);
