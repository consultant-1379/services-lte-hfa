...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureSubscriberEventSummaryResultRaw;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHFASubscriberEventSummaryServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureSubscriberEventSummaryResultRaw> {
    ...
    public void testSubscriberEventSummaryPrep() throws Exception {
        ...
        final ResultTranslator<LTEHandoverFailureSubscriberEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureSubscriberEventSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureSubscriberEventSummaryResultRaw.class);
        assertResult(eventResult);
    }

    @Test
    public void testSubscriberEventSummaryPrepByWeek() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureSubscriberEventSummaryResultRaw> results) {
        assertThat(results.size(), is(4));
        for (final LTEHandoverFailureSubscriberEventSummaryResultRaw rs : results) {
