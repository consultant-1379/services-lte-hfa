 ...
 *
 */
public class LTEHFAENodeBQCICategorySummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAQOSENodeBQCICategorySummaryResult> {
    ...
    @Test
    public void testENodeBQCICategaryEventSummary() throws Exception {
        final String json = getJsonResult();
        final ResultTranslator<LTEHFAQOSENodeBQCICategorySummaryResult> rt = getTranslator();
        final List<LTEHFAQOSENodeBQCICategorySummaryResult> eventResult = rt.translateResult(json,
                LTEHFAQOSENodeBQCICategorySummaryResult.class);
