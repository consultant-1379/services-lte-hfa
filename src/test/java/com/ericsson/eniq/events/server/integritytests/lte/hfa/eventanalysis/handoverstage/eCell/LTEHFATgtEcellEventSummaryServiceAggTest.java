...
public class LTEHFATgtEcellEventSummaryServiceAggTest extends BaseDataIntegrityTest<LTEHFATgtEcellEventSummaryResultRaw> {
    ...
    public void testtgtEcellEventSummaryDayPrep() throws Exception {
        ...
        final List<LTEHFATgtEcellEventSummaryResultRaw> eventResult = rt.translateResult(json, LTEHFATgtEcellEventSummaryResultRaw.class);
