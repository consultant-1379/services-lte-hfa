 ...
 *
 */
public class LTEHFATgtEcellEventSummaryServiceRawTest extends
    ...
    private void insertData(final long thier3Id, final String eventID, final String categoryId, final int tac,
            final String time, final int instances) throws SQLException {
        for (int i = 0; i < instances; i++) {
            final Map<String, Object> valuesForTable = new HashMap<String, Object>();
            valuesForTable.put(EVENT_ID, eventID);
            valuesForTable.put(THIER321_HASHID, thier3Id);
    ...
    @Test
    public void testtgtEcellEventSummaryPrep() throws Exception {
    ...
    @Test
    public void testtgtEcellEventSummaryExec() throws Exception {
    ...
    private void assertResult(final List<LTEHFATgtEcellEventSummaryResultRaw> results) {
