...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.hfa.ranking.LTEHFACCExecRankingService;
 ...
 *
 */
public class LTEHFACauseCodeRankingExecServiceRawTest extends
    ...
    public void onSetUp() throws Exception {
    	LTEHandoverFailureCCExecRankingService = new LTEHFACCExecRankingService();
        attachDependencies(LTEHandoverFailureCCExecRankingService);
    ...
    private void insertData() throws SQLException {
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_1, TEST_VALUE_CAUSE_CODE_DESC_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA);
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_2, TEST_VALUE_CAUSE_CODE_DESC_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA);
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_3, TEST_VALUE_CAUSE_CODE_DESC_3, INTERNAL_PROC_HO_EXEC_S1_IN_HFA);
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_4, TEST_VALUE_CAUSE_CODE_DESC_4, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA);

        insertTopoData(INTERNAL_PROC_HO_EXEC_X2_IN_HFA, "INTERNAL_PROC_HO_EXEC_X2_IN_HFA");
        insertTopoData(INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, "INTERNAL_PROC_HO_EXEC_X2_OUT_HFA");
        insertTopoData(INTERNAL_PROC_HO_EXEC_S1_IN_HFA, "INTERNAL_PROC_HO_EXEC_S1_IN_HFA");
        insertTopoData(INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, "INTERNAL_PROC_HO_EXEC_S1_OUT_HFA");
       
        //insert data to raw tables
        final String dateTime = DateTimeUtilities.getDateTimeMinus2Minutes();
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, dateTime, 4);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, dateTime, 3);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_3, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, dateTime, 2);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_4, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, dateTime, 1);
    }
    ...
    private void insertTopoData(final String eventID, final String eventTypeDesc) throws SQLException {
        ...
        valuesForTable.put(CATEGORY_ID_2, LTE_HFA_EXEC_CATEGORY_ID);
    ...
    @Test
    public void testGetLTEHFACauseCodeCallDropRankingData() throws Exception {
        ...
        final String json = runQuery(LTEHandoverFailureCCExecRankingService, requestParameters);
