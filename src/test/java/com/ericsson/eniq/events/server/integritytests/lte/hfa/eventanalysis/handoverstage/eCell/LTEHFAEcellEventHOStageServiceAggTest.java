...
public class LTEHFAEcellEventHOStageServiceAggTest extends BaseDataIntegrityTest<LTEHFAEcellEventHandoverStageResultRaw> {

    private LTEHandoverFailureECellHandoverStageService lteHandoverFailureEcellEventHandoverStageService;
    ...
    private static final String TEST_VALUE_NODE_PARAM = "ONRM_RootMo_R:LTE01ERBS00001";
    ...
    public void onSetUp() throws Exception {
        lteHandoverFailureEcellEventHandoverStageService = new LTEHandoverFailureECellHandoverStageService();
        attachDependencies(lteHandoverFailureEcellEventHandoverStageService);
    ...
    private void insertDataRaw(final String rawTable, final long imsi, final long hier321Id, final int tac, final String categoryId,
    ...
    private String getJsonResultDay(final boolean isRankingDrillDown) throws URISyntaxException {
        ...
        return runQuery(lteHandoverFailureEcellEventHandoverStageService, requestParameters);
    }
    ...
    private void insertAggDataDay() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_DAY, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_DAY_1, 1, 20);
    ...
    private void insertAggData15Min() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER321_EVENTID_ERR_15MIN, TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA,
                EventIDConstants.CATEGORY_ID_2_EXEC, DATETIME_ID_15MIN_1, 1, 20);
    ...
    @Test
    public void testEcellHandoverStageDay() throws Exception {
        insertAggDataDay();
        final String json = getJsonResultDay(false);
        final ResultTranslator<LTEHFAEcellEventHandoverStageResultRaw> rt = getTranslator();
        final List<LTEHFAEcellEventHandoverStageResultRaw> eventResult = rt.translateResult(json, LTEHFAEcellEventHandoverStageResultRaw.class);
        assertResultDay(eventResult);
    }

    @Test
    public void testEcellHandoverStage15min() throws Exception {
        insertAggData15Min();
    ...
    private void assertResultDay(final List<LTEHFAEcellEventHandoverStageResultRaw> results) {
        assertThat(results.size(), is(2));
        for (final LTEHFAEcellEventHandoverStageResultRaw rs : results) {
