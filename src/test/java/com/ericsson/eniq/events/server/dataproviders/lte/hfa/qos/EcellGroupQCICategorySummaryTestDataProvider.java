...
public class EcellGroupQCICategorySummaryTestDataProvider {

    private EcellGroupQCICategorySummaryTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS).add(TYPE_PARAM, TYPE_CELL)
