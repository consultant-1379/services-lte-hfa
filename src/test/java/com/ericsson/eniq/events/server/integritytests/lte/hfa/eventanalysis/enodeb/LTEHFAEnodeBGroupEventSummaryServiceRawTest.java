 ...
 *
 */
public class LTEHFAEnodeBGroupEventSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureENodeBGroupEventSummaryResultRaw> {
    ...
    @Test
    public void testEnodeBGroupEventSummaryPrep() throws Exception {
    ...
    @Test
    public void testEnodeBGroupEventSummaryExec() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureENodeBGroupEventSummaryResultRaw> results) {
