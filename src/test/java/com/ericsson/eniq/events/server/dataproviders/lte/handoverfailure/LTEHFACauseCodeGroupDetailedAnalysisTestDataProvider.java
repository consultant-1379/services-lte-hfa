 ...
 *
 */
public class LTEHFACauseCodeGroupDetailedAnalysisTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(GROUP_NAME_PARAM, "eNodeBCauseCode").add(CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "4111", "4110", "4113", "4112", "4103", "4102", "4105", "4104").build();
