...
public class LTEHandoverFailureEcellGroupCCPieChartServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureGroupCCPieChartResult> {
    ...
    public void testEcellCauseCodePieChartSummary() throws Exception {
        ...
        final List<LTEHandoverFailureGroupCCPieChartResult> eventResult = rt.translateResult(json, LTEHandoverFailureGroupCCPieChartResult.class);
        assertResult(eventResult);
    }

    @Test
    public void testEcellCauseCodePieChartSummaryForWeek() throws Exception {
