 ...
 *
 */
public class LTEHFATgtEcellEventHOStageServiceRawTest extends
        BaseDataIntegrityTest<LTEHFATgtEcellEventHandoverStageResultRaw> {
    ...
    public void onSetUp() throws Exception {
        lteHandoverFailureTgtECellHandoverStageService = new LTEHandoverFailureTgtECellHandoverStageService();
        attachDependencies(lteHandoverFailureTgtECellHandoverStageService);
    ...
    private void insertData(final long thier321Id, final String eventID, final String categoryId, final int tac,
    ...
    private String getJsonResult(final boolean isRankingDrillDown) throws URISyntaxException {
        ...
        // }
        return runQuery(lteHandoverFailureTgtECellHandoverStageService, requestParameters);
    }
    ...
    @Test
    public void testtgtEcellHandoverStage() throws Exception {
        final String json = getJsonResult(false);
        final ResultTranslator<LTEHFATgtEcellEventHandoverStageResultRaw> rt = getTranslator();

        final List<LTEHFATgtEcellEventHandoverStageResultRaw> eventResult = rt.translateResult(json,
                LTEHFATgtEcellEventHandoverStageResultRaw.class);
    ...
    private void assertResult(final List<LTEHFATgtEcellEventHandoverStageResultRaw> results) {
