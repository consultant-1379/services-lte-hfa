...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.qos.LTEHFAQOSENodeBQCIEventSummaryResult;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHFAENodeBQCIEventSummaryServiceAggTest extends BaseDataIntegrityTest<LTEHFAQOSENodeBQCIEventSummaryResult> {
    ...
    private static final long TEST_VALUE_HIER3_ID = 7964427362722299527L;
    ...
    private String getJsonResultAgg(final String dateFrom, final String dateTo, final int categoryID) throws URISyntaxException {
        ...
        requestParameters.putSingle(HIER3_ID, String.valueOf(TEST_VALUE_HIER3_ID));
    ...
    @Test
    public void testENodeBQCIEventSummary15MinAggPrep() throws Exception {
        ...
        final ResultTranslator<LTEHFAQOSENodeBQCIEventSummaryResult> rt = getTranslator();
        final List<LTEHFAQOSENodeBQCIEventSummaryResult> eventResult = rt.translateResult(json, LTEHFAQOSENodeBQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(2));
    }

    @Test
    public void testENodeBQCIEventSummary15MinAggExec() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_HFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_HFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testENodeBQCIEventSummaryDayAggPrep() throws Exception {
    ...
    @Test
    public void testENodeBQCIEventSummaryDayAggExec() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_HFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_HFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
