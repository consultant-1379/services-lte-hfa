 ...
 *
 */
public class LTEHFACauseCodeRankingExecServiceAggTest extends
    ...
    private void insertEventsWithCCAndDateTime(final String dateTime) throws SQLException {
        ...
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, dateTime, 1);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_3, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, dateTime, 3);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_4, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, dateTime, 2);
    ...
    private String getJsonWithTimerange(final String timerange) {
        ...
        return runQuery(LTEHandoverFailureCCExecRankingService, requestParameters);
    }
