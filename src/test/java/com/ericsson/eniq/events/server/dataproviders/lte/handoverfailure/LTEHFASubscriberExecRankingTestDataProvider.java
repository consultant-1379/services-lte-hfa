...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.LTE_HFA_EXEC_CATEGORY_ID;
 ...
 *
 */
public class LTEHFASubscriberExecRankingTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(CATEGORY_ID_SQL_PARAM, LTE_HFA_EXEC_CATEGORY_ID).add(MAX_ROWS, DEFAULT_MAX_ROWS).build();
