 ...
 *
 */
public class LTEHFAeNodeBExecRankingServiceAggTest extends
    ...
    @Test
    public void testGetLTEHFAeNodeBExecRankingDataAgg15MIN() throws Exception {
    ...
    @Test
    public void testGetLTEHFAeNodeBExecRankingDataAggDAY() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(DISPLAY_PARAM, GRID);
