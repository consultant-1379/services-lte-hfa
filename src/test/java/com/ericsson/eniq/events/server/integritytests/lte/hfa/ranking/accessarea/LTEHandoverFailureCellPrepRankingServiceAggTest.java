...
public class LTEHandoverFailureCellPrepRankingServiceAggTest extends
    ...
    private void insertSourcecell(final String hier3ID, final String hier321ID, final String dateTime,
    ...
    private void insertTargetcell(final String thier3ID, final String thier321ID, final String dateTime,
            final int instances) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
        for (int i = 0; i < instances; i++) {
            valuesForTable.clear();
