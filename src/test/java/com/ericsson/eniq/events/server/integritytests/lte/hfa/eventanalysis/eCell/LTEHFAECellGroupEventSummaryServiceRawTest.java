 ...
 *
 */
public class LTEHFAECellGroupEventSummaryServiceRawTest extends
    ...
    @Test
    public void testECellGroupEventSummaryPrep() throws Exception {
    ...
    @Test
    public void testECellGroupEventSummaryExec() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureECellGroupEventSummaryResultRaw> results) {
