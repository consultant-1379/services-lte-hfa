...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureEventHandoverStageResultRaw;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHFAEventHandoverStageServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureEventHandoverStageResultRaw> {
    ...
    private String getJsonResult(final String categoryType) throws URISyntaxException {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(DISPLAY_PARAM, GRID);
        ...
        requestParameters.putSingle(MAX_ROWS, DEFAULT_MAX_ROWS);
        requestParameters.putSingle(TYPE_PARAM, IMSI);
        requestParameters.putSingle(CATEGORY_ID_PARAM, String.valueOf(categoryType));
    ...
    public void testSubscriberEventHandoverStageSummary() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);

        final String failureRowsInserted = "16";

        final String json = getJsonResult(DATE_FROM_RAW, DATE_TO_RAW);
        final ResultTranslator<LTEHandoverFailureEventHandoverStageResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureEventHandoverStageResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureEventHandoverStageResultRaw.class);
        assertResult(eventResult, 2, failureRowsInserted);
    }

    @Test
    public void testSubscriberEventHandoverStageSummary_WeekQuery() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC, SAMPLE_TAC, DATETIME_ID_RAW_Agg, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, EventIDConstants.CATEGORY_ID_2_EXEC,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW_Agg, 2);
    ...
    @Test
    public void testSubscriberEventHandoverStageSummary_Preparation() throws Exception {
        ...
        final String failureRowsInserted = "8";

        final String json = getJsonResult(CATEGORY_ID_2_PREP);
        final ResultTranslator<LTEHandoverFailureEventHandoverStageResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureEventHandoverStageResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureEventHandoverStageResultRaw.class);
        assertResult(eventResult, 1, failureRowsInserted);
    }

    @Test
    public void testSubscriberEventHandoverStageSummary_Execution() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureEventHandoverStageResultRaw> results, final int expected, final String failures) {
        assertThat(results.size(), is(expected));
        for (final LTEHandoverFailureEventHandoverStageResultRaw rs : results) {
            assertEquals(failures, rs.getNoOfErrors());
            assertEquals("123456789012345", rs.getImsi());
        }
    }
}
