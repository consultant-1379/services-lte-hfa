...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureCCPieChartResult;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHandoverFailureEcellCCPieChartServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureCCPieChartResult> {
    ...
    private void insertRawData() throws Exception {
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testEcellCauseCodePieChartSummaryRaw() throws Exception {
        final String json = getJsonResult(DATE_FROM_RAW, DATE_TO_RAW);
        final ResultTranslator<LTEHandoverFailureCCPieChartResult> rt = getTranslator();
        final List<LTEHandoverFailureCCPieChartResult> eventResult = rt.translateResult(json, LTEHandoverFailureCCPieChartResult.class);
        assertResult(eventResult);
    }

    @Test
    public void testEcellCauseCodePieChartSummaryAgg() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureCCPieChartResult> results) {
        assertThat(results.size(), is(8));
        for (final LTEHandoverFailureCCPieChartResult rs : results) {
