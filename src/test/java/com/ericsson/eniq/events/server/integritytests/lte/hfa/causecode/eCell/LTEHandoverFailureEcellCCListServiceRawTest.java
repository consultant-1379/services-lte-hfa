...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureCCListResult;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHandoverFailureEcellCCListServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureCCListResult> {
    ...
    private static final String DATE_FROM_RAW = "19092011";

    private static final String DATE_TO_RAW = "19092011";
    ...
    private void insertData(final long hier321Id, final String eventID, final String causeCD, final int tac, final String time) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private String getJsonResult(final String dateFrom, final String dateTo) throws URISyntaxException {
        ...
        requestParameters.putSingle(CELL_SQL_ID, Long.toString(TEST_VALUE_HIER321_ID));
        return runQuery(lteHandoverFailureEcellCauseCodeListService, requestParameters);
    }

    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);

        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, SAMPLE_TAC, DATETIME_ID_RAW);
        insertData(TEST_VALUE_HIER321_ID, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, TEST_VALUE_CAUSE_CODE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW);
    ...
    @Test
    public void testEcellCauseCodeListRaw() throws Exception {
        final String json = getJsonResult(DATE_FROM_RAW, DATE_TO_RAW);
        final ResultTranslator<LTEHandoverFailureCCListResult> rt = getTranslator();
        final List<LTEHandoverFailureCCListResult> eventResult = rt.translateResult(json, LTEHandoverFailureCCListResult.class);
        assertThat(eventResult.size(), is(8));
    }

    @Test
    public void testEcellCauseCodeListAgg() throws Exception {
