 ...
 *
 */
public class LTEHFAEnodeBQCIDetailedEventAnalysisTestDataProvider {
    private LTEHFAEnodeBQCIDetailedEventAnalysisTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(HIER3_ID, TEST_VALUE_LTE_HFA_HIER3_ID)
