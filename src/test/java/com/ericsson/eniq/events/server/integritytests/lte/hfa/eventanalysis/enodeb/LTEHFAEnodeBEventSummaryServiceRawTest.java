 ...
 *
 */
public class LTEHFAEnodeBEventSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureEnodeBEventSummaryResultRaw> {
    ...
    @Test
    public void testEnodeBEventSummaryPrep() throws Exception {
    ...
    @Test
    public void testEnodeBEventSummaryExec() throws Exception {
    ...
    /* @Test
     public void testEnodeBEventSummaryRankingDrilldownPrep() throws Exception {
    ...
    private void assertResult(final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> results) {
