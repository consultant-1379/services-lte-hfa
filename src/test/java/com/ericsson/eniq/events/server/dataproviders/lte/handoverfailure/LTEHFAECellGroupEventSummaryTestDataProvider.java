 ...
 *
 */
public class LTEHFAECellGroupEventSummaryTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(GROUP_NAME_PARAM, "tempAccessAreaGroup")
                .add(CATEGORY_ID_SQL_PARAM, CATEGORY_ID_2_PREP, CATEGORY_ID_2_EXEC)
                .build();
