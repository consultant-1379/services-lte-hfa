...
public class LTEHFAECellDetailedAnalysisServiceRawTest extends BaseDataIntegrityTest<LTEHFAECELLDetailedAnalysisSetupResult> {
    ...
    @Test
    public void testEcellAnalysisDetailedExecS1OutEvent_RawGrpForWeek() throws Exception {
    ...
    private void assertResult(final List<LTEHFAECELLDetailedAnalysisSetupResult> results, final String eventId) {
        ...
        for (LTEHFAECELLDetailedAnalysisSetupResult rs : results) {
