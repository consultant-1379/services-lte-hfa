...
public class LTEHandoverFailureCellExecRankingServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureCellRankingResult> {
    ...
    private static final String TEST_VALUE_ENODEB_NAME_4 = "";

    private static final String TEST_VALUE_ECELL_NAME_4 = "";

    private static final String TEST_VALUE_HIER3_ID_4 = "0";

    private static final String TEST_VALUE_HIER321_ID_4 = "0";
    ...
    private void insertcell(final String hier3ID, final String hier321ID, final String thier3ID, final String thier321ID, final String dateTime,
    ...
    private void insertCellWithDateTime(final String dateTime) throws SQLException {
        insertcell(TEST_VALUE_HIER3_ID_1, TEST_VALUE_HIER321_ID_1, TEST_VALUE_THIER3_ID_1, TEST_VALUE_THIER321_ID_1, dateTime, 3);
        insertcell(TEST_VALUE_HIER3_ID_2, TEST_VALUE_HIER321_ID_2, TEST_VALUE_THIER3_ID_2, TEST_VALUE_THIER321_ID_2, dateTime, 2);
        insertcell(TEST_VALUE_HIER3_ID_3, TEST_VALUE_HIER321_ID_3, TEST_VALUE_THIER3_ID_3, TEST_VALUE_THIER321_ID_3, dateTime, 1);
        insertcell(TEST_VALUE_HIER3_ID_4, TEST_VALUE_HIER321_ID_4, TEST_VALUE_THIER3_ID_4, TEST_VALUE_THIER321_ID_4, dateTime, 1);
    }

    //SourceCellExec Testing
    @Test
    public void testGetLTEHFASourceCellExecRankingData() throws Exception {
    ...
    private void assertResultSource(final List<LTEHandoverFailureCellRankingResult> rankingResult) {
        ...
        assertThat(result3.getHier321ID(), is(TEST_VALUE_HIER321_ID_4));
        assertThat(result3.getEnodeB(), is(TEST_VALUE_ENODEB_NAME_4));
        assertThat(result3.getCell(), is(TEST_VALUE_ECELL_NAME_4));
        assertThat(result3.getVendor(), is(""));
        assertThat(result3.getRatDesc(), is(""));
        assertThat(result3.getFailures(), is(1));

        final LTEHandoverFailureCellRankingResult result4 = rankingResult.get(3);
        assertThat(result4.getRank(), is(3));
        assertThat(result4.getCategoryID(), is(CATEGORY_ID_2_EXEC));
        assertThat(result4.getHier321ID(), is(TEST_VALUE_HIER321_ID_3));
        assertThat(result4.getEnodeB(), is(TEST_VALUE_ENODEB_NAME_3));
        assertThat(result4.getCell(), is(TEST_VALUE_ECELL_NAME_3));
        assertThat(result4.getVendor(), is(ERICSSON));
        assertThat(result4.getRatDesc(), is("LTE"));
