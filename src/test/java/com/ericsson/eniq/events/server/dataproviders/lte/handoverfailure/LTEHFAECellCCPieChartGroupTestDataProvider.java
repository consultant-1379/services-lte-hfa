 ...
 *
 */
public class LTEHFAECellCCPieChartGroupTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(CAUSE_CODE_ID_LIST, "4102-1,4103-1,4104-1,4105-1,4110-1,4111-1,4112-1,4113-1")
                .add(GROUP_NAME_PARAM, "tempCellGroup").add(TYPE_PARAM, TYPE_CELL).build();
