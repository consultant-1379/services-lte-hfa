...
public class LTEHandoverFailureEcellGroupCCListServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureGroupCCListResult> {
    ...
    public void testEcellGroupCauseCodeSummary() throws Exception {
        ...
        final List<LTEHandoverFailureGroupCCListResult> eventResult = rt.translateResult(json, LTEHandoverFailureGroupCCListResult.class);
        assertThat(eventResult.size(), is(8));
    }

    @Test
    public void testEcellGroupCauseCodeSummaryForWeek() throws Exception {
