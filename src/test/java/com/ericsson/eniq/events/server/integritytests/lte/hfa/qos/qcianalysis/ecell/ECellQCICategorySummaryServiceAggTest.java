...
public class ECellQCICategorySummaryServiceAggTest extends BaseDataIntegrityTest<LTEHFAQOSECellQCICategorySummaryResult> {
    ...
    private void insertAggData(final String aggTable, final long hier321ID, final int categoryID, final int qciID, final String time,
    ...
    public void testECellQCICategorySummary15MinAgg() throws Exception {
        ...
        final List<LTEHFAQOSECellQCICategorySummaryResult> eventResult = rt.translateResult(json, LTEHFAQOSECellQCICategorySummaryResult.class);
