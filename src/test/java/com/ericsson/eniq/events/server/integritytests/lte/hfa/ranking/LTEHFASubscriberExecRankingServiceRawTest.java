...
public class LTEHFASubscriberExecRankingServiceRawTest extends BaseDataIntegrityTest<LTEHandoverFailureSubscriberExecRankingSetupResult> {
    ...
    public void testSubscriberExecRanking_Raw() throws Exception {
        ...
        final String json = getJsonResult(LTE_HFA_EXEC_CATEGORY_ID, DATE_FROM_RAW, DATE_TO_RAW);
    ...
    @Test
    public void testSubscriberExecRanking_Agg() throws Exception {

        insertData(TEST_VALUE_IMSI_0, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, DATETIME_ID_RAW_AGG, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, DATETIME_ID_RAW_AGG, 1);

        final String json = getJsonResult(LTE_HFA_EXEC_CATEGORY_ID, DATE_FROM_AGG_DAY, DATE_TO_AGG_DAY);
