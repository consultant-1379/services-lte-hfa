...
import com.ericsson.eniq.events.server.test.queryresults.lte.handoverfailure.LTEHandoverFailureEnodeBEventSummaryResultRaw;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class LTEHFAEnodeBEventSummaryServiceAggTest extends BaseDataIntegrityTest<LTEHandoverFailureEnodeBEventSummaryResultRaw> {
    ...
    @Test
    public void testEnodeBEventSummaryDayPrep() throws Exception {
        insertAggDataDay();
        final String json = getJsonResultDay(false, EventIDConstants.CATEGORY_ID_2_PREP);
        final ResultTranslator<LTEHandoverFailureEnodeBEventSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureEnodeBEventSummaryResultRaw.class);
        assertResultDay(eventResult);
    }

    @Test
    public void testEnodeBEventSummaryDayExec() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEnodeBEventSummary15minPrep() throws Exception {
        insertAggData15Min();
    ...
    @Test
    public void testEnodeBEventSummary15minExec() throws Exception {
        insertAggData15Min();
    ...
    /*
     * @Test public void testEnodeBEventSummaryDayRankingDrillDownPrep() throws Exception { insertAggDataDay(); final String json =
     * getJsonResultDay(true, EventIDConstants.CATEGORY_ID_2_PREP); final ResultTranslator<LTEHandoverFailureEnodeBEventSummaryResultRaw> rt =
     * getTranslator(); final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> eventResult = rt.translateResult(json,
     * LTEHandoverFailureEnodeBEventSummaryResultRaw.class); assertResultDay(eventResult); }
     *
     * @Test public void testEnodeBEventSummaryDayRankingDrillDownExec() throws Exception { insertAggDataDay(); final String json =
     * getJsonResultDay(true, EventIDConstants.CATEGORY_ID_2_EXEC); final ResultTranslator<LTEHandoverFailureEnodeBEventSummaryResultRaw> rt =
     * getTranslator(); final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> eventResult = rt.translateResult(json,
     * LTEHandoverFailureEnodeBEventSummaryResultRaw.class); assertResultDay(eventResult); }
     *
     * @Test public void testEnodeBEventSummary15minRankingDrillDownPrep() throws Exception { insertAggData15Min(); final String json =
     * getJsonResult15MIN(true, EventIDConstants.CATEGORY_ID_2_PREP); final ResultTranslator<LTEHandoverFailureEnodeBEventSummaryResultRaw> rt =
     * getTranslator(); final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> eventResult = rt.translateResult(json,
     * LTEHandoverFailureEnodeBEventSummaryResultRaw.class); assertResultDay(eventResult); }
     *
     * @Test public void testEnodeBEventSummary15minRankingDrillDownExec() throws Exception { insertAggData15Min(); final String json =
     * getJsonResult15MIN(true, EventIDConstants.CATEGORY_ID_2_EXEC); final ResultTranslator<LTEHandoverFailureEnodeBEventSummaryResultRaw> rt =
     * getTranslator(); final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> eventResult = rt.translateResult(json,
     * LTEHandoverFailureEnodeBEventSummaryResultRaw.class); assertResultDay(eventResult); }
     */

    private void assertResultDay(final List<LTEHandoverFailureEnodeBEventSummaryResultRaw> results) {
        assertThat(results.size(), is(4));
        for (final LTEHandoverFailureEnodeBEventSummaryResultRaw rs : results) {
